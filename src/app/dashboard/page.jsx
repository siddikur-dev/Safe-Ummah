    ...
    const fetchMyAppeals = async () => {
      try {
        ...
        const filtered = (data.appeals || data).filter((appeal) => {
          ...
          const appealUserId =
            appeal.userId || appeal.user?._id || appeal.user?.id;
          const appealUserEmail = (
            appeal.userEmail ||
            appeal.email ||
            appeal.user?.email
          )?.toLowerCase();
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <p className="text-3xl font-bold text-[#af002b]">
              {appeals.length}
            </p>
          </div>
          <div className="bg-white rounded-lg shadow p-6">
                  ...
                  >
                    <div className="flex flex-col md:flex-row md:items-center justify-between">
                          ...
                          <div className="flex items-center">
                            <span
                              className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                                (appeal.status || "active").toLowerCase() ===
                                "active"
                      ...
                      <div className="flex space-x-2 mt-4 md:mt-0">
                        <button
                          onClick={() =>
                            router.push(`/appeals/${appeal._id || appeal.id}`)
                          }
