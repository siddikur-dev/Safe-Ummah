        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="relative">
            <input
              ...
              onChange={handleChange}
              className="relative block w-full px-3 py-2 pr-10 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-[#af002b] focus:border-[#af002b]"
          ...
          <div className="text-center">
            ...
            <Link
              href="/login"
              className="font-medium text-[#af002b] hover:text-[#900023] transition-colors"
            >
              Sign in
            </Link>
          </div>
